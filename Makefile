#############################################################################
# Makefile for building: uefi_boot_manager
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  uefi_boot_manager.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile uefi_boot_manager.pro -spec linux-g++ CONFIG+=qtquickcompiler
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = uefi_boot_manager1.0.0
DISTDIR = /home/joseph/Documents/GitHub/UEFI-Boot-Manager/.tmp/uefi_boot_manager1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		uefi_boot_manager.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = uefi_boot_manager
DESTDIR       = 
TARGET        = uefi_boot_manager


first: all
####### Build rules

uefi_boot_manager: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: uefi_boot_manager.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		uefi_boot_manager.pro
	$(QMAKE) -o Makefile uefi_boot_manager.pro -spec linux-g++ CONFIG+=qtquickcompiler
...
all: Makefile uefi_boot_manager
...
moc_mainwindow.cpp: mainwindow.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/joseph/Documents/GitHub/UEFI-Boot-Manager/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/joseph/Documents/GitHub/UEFI-Boot-Manager -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/10.2.0 -I/usr/include/c++/10.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/10.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/uefi_boot_manager/bin || mkdir -p $(INSTALL_ROOT)/opt/uefi_boot_manager/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/uefi_boot_manager/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/uefi_boot_manager/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/uefi_boot_manager/bin/ 
